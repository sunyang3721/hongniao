...
<div class="fixed-nav layout">
    <ul>
        ...
        <li class="fixed-nav-tab"><a href="javascript:;">运费设置</a></li>
...
<div class="content padding-big have-fixed-nav">
    ...
    <!-- 商品规格结束 -->
    <div class="content-tabs margin-large-bottom hidden clearfix"><?php include template('goods_freight'); ?></div>
    <!-- 商品图册开始 -->
...
<script type="text/javascript">
            ...
            onclose: function () {
                if (this.returnValue) {
                    ...
                    if (selectType == 1) {
                        ...
                        init_delivery(productList,delivery_temps)
                    } else {
                        var specArr = [];
                        ...
                        if (select_diff.length > 0) {
                            ...
                            append_delivery(speclist,delivery_temps);
                        }
                        //删减
    ...
    $("[data-model='spec_delete']").live('click', function () {
        if (confirm("您确定执行此操作？")){
            var data_id = $(this).parent().parent('.tr').data('id');
