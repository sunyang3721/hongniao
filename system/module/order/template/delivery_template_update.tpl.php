			...
			<div class="table-wrap">
				<div class="table check-table border paging-table clearfix">
					...
					<div class="tr border-none nav-name">
						<div class="th bg-none bg-white w50"><b>配送地区</b></div>
						<div class="th bg-none bg-white w10 first_value"><b>首重</b></div>
						<div class="th bg-none bg-white w10 first_fee"><b>首重费用</b></div>
						<div class="th bg-none bg-white w10 follow_value"><b>续重</b></div>
						<div class="th bg-none bg-white w10 follow_fee"><b>续重费用</b></div>
					...
					?>
						<div class="tr template"  data-id="">
							<div class="td padding-lr w50">
								<a class="fl margin-left dialog_edit" href="javascript:;">编辑地区</a>
								<div class="text-left padding-lr text-ellipsis" title="<?php echo implode(",", $v['district_names']); ?>" data-type="name"><?php echo implode(",", $v['district_names']); ?></div>
...
<div class="tr" data-id="<%=id%>">
	<div class="td padding-lr w50 district">
		<a class="fl margin-left dialog_edit" href="javascript:;">编辑地区</a>
		<div class="text-left padding-lr text-ellipsis" data-type='name'></div>
