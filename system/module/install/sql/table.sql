...
CREATE TABLE `hd_goods_sku` (
  ...
  `delivery_template_id` mediumint(8) NOT NULL DEFAULT '0' COMMENT '运费模板id',
  PRIMARY KEY (`sku_id`),
...
CREATE TABLE `hd_goods_spu` (
  ...
  `delivery_template_id` mediumint(8) NOT NULL DEFAULT '0' COMMENT '运费模板id',
  `delivery_price` decimal(8,2) NOT NULL DEFAULT '0.00' COMMENT '统一运费',
  `delivery_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '运费方式，0为运费模板，1为统一运费',
  `delivery_set_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '运费设置方式，0为统一设置，1为按规格设置',
  PRIMARY KEY (`id`),
